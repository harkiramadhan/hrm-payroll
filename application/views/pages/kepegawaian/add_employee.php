                        ...
                        <div class="card p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-3 mb-3">
                                    ...
                                    <input class="form-control <?= (@form_error('nohp')) ? 'is-invalid' : ((@set_value('nohp')) ? 'is-valid' : '') ?>" type="number" placeholder="Nomor Handphone" name="nohp" value="<?= (@set_value('nohp')) ? @set_value('nohp') : '' ?>">
                                </div>
