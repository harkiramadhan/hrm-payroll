<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12 col-lg-8 m-auto">
            <form action="<?= site_url('kepegawaian/employee/create') ?>" method="POST">
                <div class="card p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                    <h6><strong>Tambah Pegawai</strong></h6>
                    <div class="row mt-3">
                        <div class="col-lg-4">
                            <label>NIK <small class="text-danger">* <?= strip_tags(@form_error('nik')) ?></small></label>
                            <input class="form-control <?= (@form_error('nik')) ? 'is-invalid' : ((@set_value('nik')) ? 'is-valid' : '') ?>" type="text" placeholder="NIK" name="nik" value="<?= @set_value('nik') ?>">
                        </div>
                        <div class="col-lg-8">
                            <label>Nama Lengkap</label>
                            <input class="form-control <?= (@form_error('nama')) ? 'is-invalid' : ((@set_value('nik')) ? 'is-valid' : '') ?>" type="text" placeholder="Nama Lengkap" name="nama" value="<?= @set_value('nama') ?>">
                        </div>
                        <div class="col-lg-4">
                            <label>E-Ktp <small class="text-danger">* <?= strip_tags(@form_error('ektp')) ?></small></label>
                            <input class="form-control <?= (@form_error('ektp')) ? 'is-invalid' : ((@set_value('ektp')) ? 'is-valid' : '') ?>" type="text" placeholder="E-KTP" name="ektp" value="<?= @set_value('ektp') ?>">
                        </div>
                        <div class="col-lg-4">
                            <label>Tanggal Lahir</label>
                            <input class="form-control <?= (@form_error('tgl_lahir')) ? 'is-invalid' : ((@set_value('tgl_lahir')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_lahir" value="<?= @set_value('tgl_lahir') ?>">
                        </div>
                        <div class="col-lg-4">
                            <label>Status Pernikahan<small class="text-danger">*</small></label>
                            <div class="input-group mb-3">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="nikah" id="inlineRadio1" value="t" required="" <?= (@set_value('nikah') == 't') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="inlineRadio1">Sudah Menikah</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="nikah" id="inlineRadio2" value="f" required="" <?= (@set_value('nikah') == 'f') ? 'checked' : '' ?>>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_id" class="form-control <?= (@form_error('status_id')) ? 'is-invalid' : ((@set_value('status_id')) ? 'is-valid' : '') ?>" required="">
                                    ...
                                    <?php foreach($status_kepegawaian->result() as $sk){ ?>
                                        <option value="<?= $sk->id ?>" <?= (@set_value('status_id') == $sk->id) ? 'selected' : '' ?>><?= $sk->status ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control <?= (@form_error('tgl_join_c1')) ? 'is-invalid' : ((@set_value('tgl_join_c1')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_join_c1" value="<?= (@set_value('tgl_join_c1')) ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Tanggal Finish Kontrak 1<small class="text-danger">*</small></label>
                                        <input class="form-control <?= (@form_error('tgl_out_c1')) ? 'is-invalid' : ((@set_value('tgl_out_c1')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_out_c1" value="<?= (@set_value('tgl_out_c1')) ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control <?= (@form_error('tgl_join_c2')) ? 'is-invalid' : ((@set_value('tgl_join_c2')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_join_c2" value="<?= (@set_value('tgl_join_c2')) ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Tanggal Finish Kontrak 2<small class="text-danger">*</small></label>
                                        <input class="form-control <?= (@form_error('tgl_out_c2')) ? 'is-invalid' : ((@set_value('tgl_out_c2')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_out_c2" value="<?= (@set_value('tgl_out_c2')) ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control <?= (@form_error('tgl_join_p')) ? 'is-invalid' : ((@set_value('tgl_join_p')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_join_p" value="<?= (@set_value('tgl_join_p')) ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>Tanggal Permanent<small class="text-danger">*</small></label>
                                        <input class="form-control <?= (@form_error('tgl_p')) ? 'is-invalid' : ((@set_value('tgl_p')) ? 'is-valid' : '') ?>" type="date" placeholder="Tanggal Lahir" name="tgl_p" value="<?= (@set_value('tgl_p')) ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="company_id" class="form-control <?= (@form_error('company_id')) ? 'is-invalid' : ((@set_value('company_id')) ? 'is-valid' : '') ?>" required="">
                                    ...
                                    <?php foreach($companys->result() as $c){ ?>
                                        <option value="<?= $c->id ?>" <?= (@set_value('company_id') == $c->id) ? 'selected' : '' ?> ><?= $c->company ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="jabatan_id" class="form-control <?= (@form_error('jabatan_id')) ? 'is-invalid' : ((@set_value('jabatan_id')) ? 'is-valid' : '') ?>"required="">
                                    ...
                                    <?php foreach($jabatan->result() as $j){ ?>
                                        <option value="<?= $j->id ?>" <?= (@set_value('jabatan_id') == $j->id) ? 'selected' : '' ?> ><?= $j->jabatan ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="divisi_id" class="form-control <?= (@form_error('divisi_id')) ? 'is-invalid' : ((@set_value('divisi_id')) ? 'is-valid' : '') ?>" required="" id="select-div">
                                    ...
                                    <?php foreach($divisi->result() as $d){ ?>
                                        <option value="<?= $d->id ?>" <?= (@set_value('divisi_id') == $d->id) ? 'selected' : '' ?> ><?= $d->divisi ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
