<div class="container-fluid py-4">
    <div class="card">
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-lg-8">
                    <h5 class="mb-0"><strong>Agama</strong></h5>
                </div>
                <div class="col-lg-4 text-end">
                    <button type="button" class="btn btn-sm btn-round bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#modalAdd"><i class="fas fa-plus me-2"></i> Agama</button>
                </div>
            </div>
            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h5 class="font-weight-bolder">Tambah Agama</h5>
                    </div>
                    <div class="card-body pb-0">
                        <form action="<?= site_url('religion/create') ?>" role="form text-left" method="post">
                            <div class="row">
                                <div class="col-lg-12">
