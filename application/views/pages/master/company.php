        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-4 text-end">
                    <button type="button" class="btn btn-sm btn-round bg-gradient-dark mb-0" data-bs-toggle="modal" data-bs-target="#modalAdd"><i class="fas fa-plus me-2"></i> Company</button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h5 class="font-weight-bolder">Tambah Company</h5>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Nama Company" aria-label="Nama Company" name="company" required>
                                    </div>
                                </div>
                                <div class="col-lg-8">
