            ...
            <table id="example" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="text-left w-5px">Warning</th>
            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h5 class="font-weight-bolder">Tambah Status Kepegawaian</h5>
                    </div>
                    <div class="card-body pb-0">
                        <form action="<?= site_url('master/status/create') ?>" role="form text-left" method="post">
                            <div class="row">
                                <div class="col-lg-4">
                                    <label>Status Kepegawaian <small class="text-danger">*</small></label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Status Kepegawaian" aria-label="Status Kepegawaian" name="status" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <label>Waktu Warning <small class="text-danger">*) Hari</small></label>
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" placeholder="Waktu Warning" aria-label="Waktu Warning" name="warning" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="is_active" id="inlineRadio1" value="t" required="">
                                            <label class="form-check-label" for="inlineRadio1">Active</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="is_active" id="inlineRadio2" value="f" required="">
