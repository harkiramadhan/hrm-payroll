        ...
        ?>
            <div class="card card-plain">
                ...
                <div class="card-body pb-0">
                    <form action="<?= site_url('kepegawaian/divisi/update/' . $id) ?>" role="form text-left" method="post">
                        <div class="row">
                            <div class="col-lg-12">
        ...
        foreach($get->result() as $row){
            $data[] = [
                ...
                '<div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <a class="btn btn-sm btn-round btn-link text-danger px-3 mb-0" href="'.site_url('kepegawaian/divisi/delete/' . $row->id).'"><i class="far fa-trash-alt" aria-hidden="true"></i></a>
                </div>
                <script>
                    function edit(id){
                        $.ajax({
                            url : "'.site_url('kepegawaian/divisi/edit/').'" + id,
                            type : "post",
                            data : {id : id},
